  ...
  return (
    <>
      <section className='flex'>
        <div className='flex flex-col px-[4rem] space-y-8 py-12 bg-gray-300/20'>
          ...
          <p className='text-xl font-montserrat'>BullShark is your trusted and leading licensed security <br />  organization  that  extends security consultancy, facility- <br /> management, guarding, investigations and intelligence <br /> solutions to many corporations today.</p>
